...
public class LightsTests {
    ...
    public void ourTrianglesSpot() {
        ...
        scene.addLights(new SpotLight(new Color(java.awt.Color.BLUE),
                new Point3D(10, 10, 130), new Vector(0, 2, 1),
                1, 0.0001, 0.000005));

        ImageWriter imageWriter = new ImageWriter("ourTrianglesSpot", 200, 200, 500, 500);
        Render render = new Render(imageWriter, scene);
    ...
    public void ourSphere() {
        ...
        scene.addGeometries(
                new Sphere(new Color(java.awt.Color.YELLOW), new Material(0.5, 0.5, 100), 50, new Point3D(-50, -50, 50)),
                new Sphere(new Color(java.awt.Color.BLACK), new Material(0.5, 0.5, 100), 50, new Point3D(30, 30, 80)));

        scene.addLights(new SpotLight(new Color(0, 300, 0), new Point3D(0, 50, -50),
                new Vector(1, -1, 2), 1, 0.00001, 0.00000001),
                new PointLight(new Color(0, 300, 500), new Point3D(-100, 50, -50), 1, 0.00001, 0.000001));

        ImageWriter imageWriter = new ImageWriter("ourSphere", 150, 150, 500, 500);
        Render render = new Render(imageWriter, scene);
