...
public class miniProject2 {
    ...
    public void football_hall() {
        ...
        Triangle david1 = new Triangle(new Color(java.awt.Color.BLUE),new Material(0.1, 0.5, 60, 0.8, 0),
                new Point3D(rightUp.get_x()/2,rightUp.get_y(),-height/3),
                new Point3D(leftUp.get_x()/2,leftUp.get_y(),-height/3),
                new Point3D(0,rightUp.get_y(),-5*height/6));
        Triangle david2 = new Triangle(new Color(java.awt.Color.BLUE),new Material(0.1, 0.5, 60, 0.8, 0),
                new Point3D(rightUp.get_x()/2,rightUp.get_y(),-4*height/6),
                new Point3D(leftUp.get_x()/2,leftUp.get_y(),-4*height/6),
                new Point3D(0,rightUp.get_y(),-height/4));
        ...
        scene.addGeometries(forwardWall, leftWall, rightWall, floor, roof, ball,david1,david2);
        ...
        scene.addLights(new SpotLight(new Color(80000, 80000, 80000), new Point3D(0, -length / 2 + 1, -2 * height / 3),
                ...
                new SpotLight(new Color(80000, 80000, 80000), new Point3D(0, -230, -300), new Vector(0, 1, 1.5)
                        , 1, 4E-1, 2E-3, 10));
