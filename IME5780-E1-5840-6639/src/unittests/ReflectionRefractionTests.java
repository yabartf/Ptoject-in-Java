...
public class ReflectionRefractionTests {
    ...
    public void twoSpheresOnMirrors() {
        ...
        scene.setViewPlaneDistance(10000);
        scene.setBackground(Color.BLACK);
    ...
    public void ourGeometries() {
        ...
        scene.addGeometries( //
                ...
                new Sphere(new Color(java.awt.Color.RED), new Material(0.2, 0.2, 30, 0.6, 0), // )
                        30, new Point3D(10, -35, 45)),
                new Sphere(new Color(java.awt.Color.MAGENTA), new Material(0.2, 0.2, 30, 0.6, 0), // )
                        30, new Point3D(62, -10, 35))
                );
    ...
    public void trianglesTransparentSphere1() {
        Scene scene = new Scene("Test scene");
        scene.setCamera(new Camera(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, -1, 0),5));
        scene.setViewPlaneDistance(1000);
